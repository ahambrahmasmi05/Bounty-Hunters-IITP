...
class Meow_MWAI_API {
	...
	public function rest_Text( $request ) {
		try {
			$params = $request->get_params();
			$message = isset( $params['message'] ) ? $params['message'] : '';
			if ( empty( $message ) ) {
	...
	public function rest_ImageQuery( $request ) {
		try {
			$params = $request->get_params();
			$message = isset( $params['message'] ) ? $params['message'] : '';
			if ( empty( $message ) ) {
	...
	public function rest_Vision( $request ) {
		try {
			$params = $request->get_params();
			$message = isset( $params['message'] ) ? $params['message'] : '';
			if ( empty( $message ) ) {
	...
	public function rest_Json( $request ) {
		try {
			$params = $request->get_params();
			$message = isset( $params['message'] ) ? $params['message'] : '';
			if ( empty( $message ) ) {
	 ...
	 */
	public function Vision( $message, $url, $path = null, $params = [] ) {
		global $mwai_core;
	 ...
	 * @return string The result of the AI query.
	 */
	public function Chat( $botId, $message, $params = [] ) {
	 ...
	 * @return string The result of the AI query.
	 */
  public function Text( $message, $params = [] ) {
    global $mwai_core;
		$query = new Meow_MWAI_Query_Text( $message );
		$query->inject_params( $params );
		$reply = $mwai_core->run_query( $query );
	...
	public function Image( $message, $params = [] ) {
		global $mwai_core;
	 ...
	 */
	public function Json( $message, $url = null, $path = null, $params = [] ) {
		if ( !empty( $url ) || !empty( $path ) ) {
